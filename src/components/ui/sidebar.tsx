...
>(
  (
    ...
    // This allows the sidebar to be server-rendered in the correct state.
    React.useEffect(() => {
    ...
    // We add a keyboard shortcut to toggle the sidebar.
    React.useEffect(() => {
    ...
    // We set the state here to avoid hydration mismatches.
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This is what will trigger the sidebar to slide over the content */}
        <div
          className={cn(
