      ...
      <Card>
        ...
        <CardContent>
            ...
            {filteredContributors.map((contributor) => (
              ...
              >
                ...
                <div className="text-right">
                  {/* تم تغيير لون الاسم إلى البنفسجي */}
          ...
          <div className="mt-6 pt-4 border-t text-right">
            <p className="text-lg font-semibold">إهداء خاص</p>
            <p className="text-gray-700">هذا التطبيق إهداء إلى: <span className="font-bold">يسرا ماهر</span></p>
          </div>
        </CardContent>
      </Card>
    </div>
